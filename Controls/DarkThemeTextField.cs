...
{
    internal class DarkThemeTextField : CustomTextField
    {
        public DarkThemeTextField()
        {
            ...
            backgroundBrush = new SolidBrush(Color.FromArgb(238, 238, 238));
            inputBrush = new SolidBrush(Color.Black);
            upperBrush = new SolidBrush(Color.FromArgb(255, 95, 0));
